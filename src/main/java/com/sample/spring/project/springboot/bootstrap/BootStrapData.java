...
public class BootStrapData implements CommandLineRunner {
    ...
    public BootStrapData(UserRepository userRepository, BCryptPasswordEncoder bCryptPasswordEncoder) {
    ...
    public void run(String... args) throws Exception {
        ...
        c1.setPassword(bCryptPasswordEncoder.encode("test1234"));
        ...
        c2.setLogin("bnowak");
        c2.setPassword(bCryptPasswordEncoder.encode("nowak1234"));
        ...
        c3.setPassword(bCryptPasswordEncoder.encode("krasicki1234"));
